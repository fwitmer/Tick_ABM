...
public class TickStyle implements MarkStyle<Tick> {
	 ...
	 */
	@Override
	public PlaceMark getPlaceMark(Tick agent, PlaceMark mark) {
	 ...
	 */
	@Override
	public double getElevation(Tick agent) {
			return 0;
	}
	...
	@Override
	public double getHeading(Tick agent) {
		return 0;
	}
	 ...
	 */
	@Override
	public String getLabel(Tick agent) {
		return null;
	}

	@Override
	public Color getLabelColor(Tick agent) {
			return Color.YELLOW;
	}
	 ...
	 */
	@Override
	public Offset getLabelOffset(Tick agent) {
		return labelOffset;
	}

	@Override
	public Font getLabelFont(Tick obj) {
		return null;
	}
	 ...
	 */
	@Override
	public double getLineWidth(Tick agent) {
			return 0;
	}

	@Override
	public Material getLineMaterial(Tick obj, Material lineMaterial) {
	...
	@Override
	public Offset getIconOffset(Tick obj) {
